...
public class Date212 {
	...
	public Date212(String d){
		...
		//else if (month<1||month>12) throw new IllegalArgumentException("Invalid month!");
		//else if (day>31) throw new IllegalArgumentException("Invalid day!");
 		//else if (month==2&&day>28) throw new IllegalArgumentException("Invalid day!");
 		//else if (month==1||month==3||month==5||month==7||month==8||month==10||month==12&&day>31) throw new IllegalArgumentException("Invalid day!");
		//else if (month==4||month==6||month==9||month==11&&day>30) throw new IllegalArgumentException("Invalid day!");
	}
